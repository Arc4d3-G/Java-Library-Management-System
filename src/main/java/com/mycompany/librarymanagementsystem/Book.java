...
public class Book {
    ...
    public Book() {
         ...
         *  ISBN needs to be 10-13 digits to be valid.
         */
        while(true) {
        ...
        /**
         *  Validation loop with error handling for book Title number.
         *  Title is valid so long as it's not empty.
         */
        while(true) {
        ...
        /**
         *  Validation loop with error handling for book Author number.
         *  Author is valid so long as it's not empty.
         */
        while(true) {
        ...
        /**
         *  Validation loop with error handling for book isAvailible prop.
         *  User needs to input "Y"/"N" to set isAbailible to true/false.
         */
        while(true) {
